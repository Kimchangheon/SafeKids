...
public class HomeActivity_Parent extends AppCompatActivity
    ...
    void passPushTokenToServer() //push알람 토큰을 서버로 전송
    {
        ...
        FirebaseDatabase.getInstance().getReference().child("user").child("user_parent").child(uid).updateChildren(map);//setvalue하게되면 기존의 데이터가 다 날라간다.
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.home_activity__parent, menu);
        return true;
    }
